...
public class RoboDrone extends RoboAereo implements FuncionalidadesEspecificas, Explorador {
    ...
    public void solicitarMoverPara(int novoX, int novoY, int novoZ) throws RoboDesligadoException, ForaDosLimitesException, ColisaoException, AcaoNaoPermitidaException {
        // A validação de estado desligado já é feita no super.solicitarMoverPara, mas é bom manter aqui para verificações específicas do drone, como a bateria.
        ...
        // Lógica específica do Drone para limitar a altitude
        ...
        // Chama o método da superclasse com a assinatura correta (sem o ambiente)
        super.solicitarMoverPara(novoX, novoY, zDestinoAjustado);

        // Lógica específica do Drone após o movimento
        consumirBateria(3);
    }
